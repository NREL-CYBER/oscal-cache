...
var oscal = {
  ...
  inventory_item: (0, _store.composeVirtualStore)({
  ...
  control: (0, _store.composeVirtualStore)({
    fetch: function fetch() {
  ...
  group: (0, _store.composeVirtualStore)({
    fetch: function fetch() {
  ...
  implemented_requirement: (0, _store.composeVirtualStore)({
    fetch: function fetch() {
